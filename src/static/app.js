document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderActivityCard(name, details) {
    ...
    // Create share URL and text (sanitize activity name and description)
    ...
    const shareText = encodeURIComponent(`Check out ${sanitizedName} at Mergington High School! ${sanitizedDescription}`);
    const shareTitle = encodeURIComponent(sanitizedName);
    ...
    const socialShareButtons = `
      <div class="social-share-buttons">
        ...
        <a href="mailto:?subject=${shareTitle}&body=${encodeURIComponent(`${decodeURIComponent(shareText)} ${decodeURIComponent(shareUrl)}`)}" 
